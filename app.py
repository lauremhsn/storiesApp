...
<div style="display:flex; align-items:baseline; gap:1rem; margin-bottom:0.2rem;">
    ...
    <span style="font-size:0.9rem; color:#aaa; font-weight:500; letter-spacing:0.05em;">
        INTELLIGENCE DASHBOARD · {selected_year}
    </span>
</div>
""", unsafe_allow_html=True)
...
with k1:
    metric_card("Active Branches", f"{total_branches}", f"Full year {selected_year}")
with k2:
...
with tab2:
    ...
    ax3.set_title(f'{selected} — Monthly Revenue {selected_year}', fontweight='bold', pad=10)
